...
const EN: UiStrings = {
  ...
  yaml: "YAML",
  yamlNote: "Frontmatter only. Book always matches the workshop book; edit the other fields after Generate. Saved per book in this browser.",
...
const ES: UiStrings = {
  ...
  yaml: "YAML",
  yamlNote: "Solo frontmatter. El libro siempre sigue al libro del taller; edita los demás campos después de Generate. Se guarda por libro en este navegador.",
